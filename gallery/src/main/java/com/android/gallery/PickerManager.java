...
import com.android.gallery.models.BaseFile;
...
public class PickerManager {
    ...
    public void addDocTypes() {
        String[] pdfs = {"pdf"};
        fileTypes.add(new FileType(FilePickerConst.PDF, pdfs, R.drawable.icon_file_pdfs));
        ...
        fileTypes.add(new FileType(FilePickerConst.XLS, xlss, R.drawable.icon_file_xlss));
